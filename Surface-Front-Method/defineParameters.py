...
params['Rt'] = 0.01 # Rt is the tunnelling resistance amplitude (assumed the same for all islands)
...
#----------
# front method parameters
#----------
params['y_pos'] = np.linspace(-params['electrode_height']/2,params['electrode_height']/2,params['n'])
params['dy'] =  params['y_pos'][1] - params['y_pos'][0]
