...
params = { # create a dictionary to hold parameters
    ...
    #--------------------------------
    'L_x' : 25.,#60, #100, # Size of material in x-direction
...
if not params['is_Voltage_constant']:
    ...
    end_volt = 6.
    start_volt = 0.
    increment = 0.05 # increment of the voltage per step
    ...
    params["V_func"] = voltage_mono_direction
...
if __name__ == "__main__": # graph the voltage
    ...
    if False: # plt pinning potentials
